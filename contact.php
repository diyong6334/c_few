					...
					<div class="col-lg-5 col-md-5 m-b30">
						<div class="bg-primary text-white contact-info-bx">
							...
							<div class="widget widget_getintuch">	
								<ul>
									<li><i class="ti-location-pin"></i>No.15 Boulevard Crescent Liberty Dam Road.Jos
									Plateau State,
								Nigeria</li>
									<li><i class="ti-mobile"></i>+234706224-9235 (24/7 Support Line)</li>
									<li><i class="ti-email"></i>cearthwork@gmail.com</li>
								</ul>
							</div>
